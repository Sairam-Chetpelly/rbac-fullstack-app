                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      {selectedVisa.country?.placeImage ? (
                        <img 
                          src={`${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/countries/${selectedVisa.country.placeImage}`} 
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          {visa.country?.placeImage ? (
                            <img 
                              src={`${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/countries/${visa.country.placeImage}`} 
