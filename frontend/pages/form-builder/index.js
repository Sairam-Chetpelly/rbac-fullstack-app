                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      {selectedVisa.country?.placeImage ? (
                        <img 
                          src={`${process.env.NEXT_PUBLIC_API_BASE_URL?.replace('/api', '') || 'https://api.oneworldvisa.inisa.inisa.inisa.inisa.in'}/uploads/countries/${selectedVisa.country.placeImage}`} 
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          {visa.country?.placeImage ? (
                            <img 
                              src={`${process.env.NEXT_PUBLIC_API_BASE_URL?.replace('/api', '') || 'https://api.oneworldvisa.inisa.inisa.inisa.in'}/uploads/countries/${visa.country.placeImage}`} 
