...
const VisaApplicationForm = () => {
  ...
  const handleFileView = (fileData) => {
    ...
    const url = fileUrl || `${process.env.API_BASE_URL.replace('/api', '')}/uploads/applications/${filePath}`;
    ...
    return (
      <div className="mt-4 relative group">
        ...
        {isImage ? (
          <div>
            <img 
              src={fileUrl || `${process.env.API_BASE_URL.replace('/api', '')}/uploads/applications/${filePath}`}
              alt={fileName}
