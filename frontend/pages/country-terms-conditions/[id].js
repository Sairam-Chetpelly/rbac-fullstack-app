...
export default function EditCountryTermsConditions() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await api.put(`/country-terms-conditions/${id}`, formData);
      ...
      <div className="max-w-4xl mx-auto space-y-6 lg:space-y-8 p-4 sm:p-6 lg:p-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 lg:gap-6">
          ...
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">✏️ Edit Country Terms & Conditions</h1>
            <p className="text-sm sm:text-base text-gray-600">Update country terms and conditions</p>
          </div>
        </div>
