      ...
      render: (value) => (
        <div className="flex items-center gap-2">
          {value?.country?.placeImage ? (
            <img 
              src={`${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/countries/${value.country.placeImage}`} 
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      {app.countryVisaType?.country?.placeImage ? (
                        <img 
                          src={`${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/countries/${app.countryVisaType.country.placeImage}`} 
