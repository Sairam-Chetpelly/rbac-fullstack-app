...
export default function AgentRegister() {
  ...
  return (
    <div className="min-h-screen via-white to-purple-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className=" from-blue-600 to-purple-600 px-8 py-6">
            <div className="text-center">
              <img src="/optionslogo.png" alt="One World Visa" className="h-20 w-auto mx-auto mb-4" />
              <h1 className="text-3xl font-bold">Agent Registration</h1>
              <p className="text-100 mt-2">Join our network of trusted visa agents</p>
            </div>
          </div>
          <div className="p-8">
