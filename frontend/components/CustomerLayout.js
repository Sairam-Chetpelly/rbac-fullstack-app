  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`bg-white border-r border-gray-200 shadow-sm h-screen transition-all duration-300 fixed left-0 top-0 z-40 flex flex-col ${
        ...
        <div className="p-3 sm:p-4 lg:p-6 flex-shrink-0 pt-20 sm:pt-24">
          <div className="flex justify-between items-center mb-4 sm:mb-6 lg:mb-8">
            ...
            >
              <span className="text-xl lg:text-2xl">{sidebarCollapsed ? '☰' : '✕'}</span>
            </button>
          </div>
        </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-110 active:scale-95"
