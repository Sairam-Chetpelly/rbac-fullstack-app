...
const { getVisaTermsConditions, createVisaTermsConditions, updateVisaTermsConditions, deleteVisaTermsConditions } = require('../controllers/visaTermsConditionsController');
