...
const fieldLibraryRoutes = require('./routes/fieldLibraryRoutes');
const sectionLibraryRoutes = require('./routes/sectionLibraryRoutes');
...
app.use('/api/section-library', sectionLibraryRoutes);
